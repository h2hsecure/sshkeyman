...
func (libnss LibNssExternal) PasswdAll() (nss.Status, []nssStructs.Passwd) {
	return nss.StatusSuccess, []nssStructs.Passwd{}
}

func (libnss LibNssExternal) PasswdByName(name string) (nss.Status, nssStructs.Passwd) {
...
func (libnss LibNssExternal) PasswdByUid(uid uint) (nss.Status, nssStructs.Passwd) {
...
func (libnss LibNssExternal) GroupAll() (nss.Status, []nssStructs.Group) {
	// fmt.Printf("GroupAll\n")
	return nss.StatusSuccess, []nssStructs.Group{}
}

// GroupByName returns a group, not managed here
func (libnss LibNssExternal) GroupByName(name string) (nss.Status, nssStructs.Group) {
	// fmt.Printf("GroupByName %s\n", name)
	return nss.StatusNotfound, nssStructs.Group{}
}

// GroupBuGid retusn group by id, not managed heresSS
func (libnss LibNssExternal) GroupByGid(gid uint) (nss.Status, nssStructs.Group) {
...
func (libnss LibNssExternal) ShadowAll() (nss.Status, []nssStructs.Shadow) {
...
func (libnss LibNssExternal) ShadowByName(name string) (nss.Status, nssStructs.Shadow) {
